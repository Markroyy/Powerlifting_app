...
import { Download, Calculator, Dumbbell, TrendingUp } from 'lucide-react';
  ...
  const completeBlock = () => {
    ...
    ['squat', 'bench', 'deadlift'].forEach(lift => {
      ...
      if (performanceData.length > 0) {
        ...
        switch(lift) {
          case 'squat':
            liftProgressionFactor = 1.035; // ~5-7kg progression when things go well
            break;
          case 'bench':
            liftProgressionFactor = 1.015; // ~1.5-2kg progression when things go well
            break;
          case 'deadlift':
            liftProgressionFactor = 1.04; // ~5-7.5kg progression when things go well
            break;
        }
        ...
        switch(lift) {
          case 'squat':
            maxIncrease = currentMax + 10; // Max 10kg increase per block
        ...
        switch(lift) {
          case 'squat':
            conservativeIncrease = 5; // 5kg when no data
            break;
          case 'bench':
            conservativeIncrease = 1.25; // Still small for bench
            break;
          case 'deadlift':
            conservativeIncrease = 5; // 5kg when no data
            break;
...
export default PowerliftingApp;
